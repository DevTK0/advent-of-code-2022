...
function score(outcome: Outcome, enemy: Enemy) {
    // outcome WIN
    if (outcome === "X" && enemy === "A") return PAPER + val(outcome);
    if (outcome === "X" && enemy === "B") return SCISSORS + val(outcome);
    if (outcome === "X" && enemy === "C") return ROCK + val(outcome);
    // outcome DRAW
    ...
    // outcome LOSE
    if (outcome === "Z" && enemy === "A") return SCISSORS + val(outcome);
    if (outcome === "Z" && enemy === "B") return ROCK + val(outcome);
    if (outcome === "Z" && enemy === "C") return PAPER + val(outcome);
